...
Variational inference technique is used to approximate the posterior distribution of DPMM.
Marginalization of discrete random variable is presented to reduce variation of gradient to provide stable training.
An example of prune heuristic is presented.
...
Thus, we do posterior predictive check using Pyro's `Predictive` function to sample from posterior distribution.
